package ua.com.zhmaka.Shoppingbackend.config;
...
@Configuration
@ComponentScan(basePackages = { "ua.com.zhmaka.Shoppingbackend.dto" })
...
public class HibernateConfig {
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("ua.com.zhmaka.Shoppingbackend.dto");
